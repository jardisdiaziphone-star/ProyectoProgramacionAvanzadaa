...
namespace ProyectoProgramacionAvanzada.Controllers
{
    public class EstudiantesController : Controller
    {
        ...
        {
            var estudiantes = db.Estudiantes.Include(e => e.Cursos);
        ...
        public ActionResult Create([Bind(Include = "IdEstudiante,Nombre,Curso,IdCurso")] Estudiantes estudiantes)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IdEstudiante,Nombre,Curso,IdCurso")] Estudiantes estudiantes)
        {
            if (ModelState.IsValid)
            {
